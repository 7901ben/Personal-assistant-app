...
import com.hfad.personalassistance.R;
...
public class MainActivityWeather extends AppCompatActivity {
    String CITY;
    String API = "187606840d46566958edd79cc354d10c";
    ImageView search;
    EditText etCity;
...
// SET ALL VALUES IN TEXTBOX :
                ...
                Toast.makeText(MainActivityWeather .this, "Error:" + e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
}